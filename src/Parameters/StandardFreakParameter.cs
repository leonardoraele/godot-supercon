...
[Tool][GlobalClass]
public partial class StandardFreakParameter : Resource, IFreakParameter
{
	//------------------------------------------------------------------------------------------------------------------
	// STATICS
	//------------------------------------------------------------------------------------------------------------------
	...
	bool IFreakParameter.IsReadOnly => false;
	...
	Variant IFreakParameter.RunGetter(IReadOnlyFreakParameterContainer source, Variant storedValue)
	...
	Variant IFreakParameter.RunSetter(IReadOnlyFreakParameterContainer container, Variant value)
	{
	...
	private Variant ExecuteSetterExpression(IReadOnlyFreakParameterContainer container, Variant input)
	{
